...
(function(w) {
    ...
    */
    function init() {
        ...
        //Needs to be a multiple of the resolution value below.
        canvas_width = Math.floor(window.innerWidth / 10) * 10
        canvas_height = Math.floor(window.innerHeight / 10) * 10
    ...
    function update_particle() {
        ...
        for (i = 0; i < particles.length; i++) {
            ...
            if (p.x >= 0 && p.x < canvas_width && p.y >= 0 && p.y < canvas_height) {
                ...
                */
                p.xv += (1 - ax) * cell_data.xv * 0.01;
                p.yv += (1 - ay) * cell_data.yv * 0.01;
                ...
                */
                p.xv += ax * cell_data.right.xv * 0.01;
                p.yv += ax * cell_data.right.yv * 0.01;
                
                p.xv += ay * cell_data.down.xv * 0.01;
                p.yv += ay * cell_data.down.yv * 0.01;
...
// HACK. Safari doesn't always show images :/ 
setTimeout(function() { 
    document.getElementById("image").src="images/josh.jpg";
}, 1);